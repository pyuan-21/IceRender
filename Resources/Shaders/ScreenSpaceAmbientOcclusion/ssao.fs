/* This file is automatically generated by "Resources/Shaders/ScreenSpaceAmbientOcclusion/ssao.iter_fs". */
...
uniform int ssaoHalfKernelSize; /*indicate an area for searching occluders*/
...
/* below codes are generated by "unroll_shader" command.*/
    ambientOcclusion += ComputeAO(-3.000000, -3.000000);
    ambientOcclusion += ComputeAO(-3.000000, -2.000000);
    ambientOcclusion += ComputeAO(-3.000000, -1.000000);
    ambientOcclusion += ComputeAO(-3.000000, 0.000000);
    ambientOcclusion += ComputeAO(-3.000000, 1.000000);
    ambientOcclusion += ComputeAO(-3.000000, 2.000000);
    ambientOcclusion += ComputeAO(-3.000000, 3.000000);
    ambientOcclusion += ComputeAO(-2.000000, -3.000000);
    ambientOcclusion += ComputeAO(-2.000000, -2.000000);
    ambientOcclusion += ComputeAO(-2.000000, -1.000000);
    ambientOcclusion += ComputeAO(-2.000000, 0.000000);
    ambientOcclusion += ComputeAO(-2.000000, 1.000000);
    ambientOcclusion += ComputeAO(-2.000000, 2.000000);
    ambientOcclusion += ComputeAO(-2.000000, 3.000000);
    ambientOcclusion += ComputeAO(-1.000000, -3.000000);
    ambientOcclusion += ComputeAO(-1.000000, -2.000000);
    ambientOcclusion += ComputeAO(-1.000000, -1.000000);
    ambientOcclusion += ComputeAO(-1.000000, 0.000000);
    ambientOcclusion += ComputeAO(-1.000000, 1.000000);
    ambientOcclusion += ComputeAO(-1.000000, 2.000000);
    ambientOcclusion += ComputeAO(-1.000000, 3.000000);
    ambientOcclusion += ComputeAO(0.000000, -3.000000);
    ambientOcclusion += ComputeAO(0.000000, -2.000000);
    ambientOcclusion += ComputeAO(0.000000, -1.000000);
    ambientOcclusion += ComputeAO(0.000000, 0.000000);
    ambientOcclusion += ComputeAO(0.000000, 1.000000);
    ambientOcclusion += ComputeAO(0.000000, 2.000000);
    ambientOcclusion += ComputeAO(0.000000, 3.000000);
    ambientOcclusion += ComputeAO(1.000000, -3.000000);
