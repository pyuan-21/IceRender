/* This file is automatically generated by "Resources/Shaders/DeferredShading/deferred_shading_ssao.main_fs". */
#version 450 core
...
/* This version is for deferred shading */
...
float ComputeLightRatio(LightCamInfo lightCamInfo, sampler2D shadowMap, sampler2D SATMap)
{
	...
	vec4 clipCoord = lightCamInfo.lightMat*vec4(fPos,1.0); /*clip space*/
